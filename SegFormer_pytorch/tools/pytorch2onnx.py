...
def pytorch2onnx(model,
    ...
    dynamic_axes = {'input':{0:'batch', 2:'width', 3:'height'},  'output':{0:'batch', 2:'width',3:'height'}}
    with torch.no_grad():
        # torch.onnx.export(
        #     model, (img_list, ),
        #     output_file,
...
def parse_args():
    ...
    parser.add_argument('--checkpoint', help='checkpoint file', default='../weights/mit_b0.pth')
...
def test_onnx(model):
    ...
    import onnx
    output_file = '/app/weights/mit_b0.onnx'
    model.cpu().eval()
